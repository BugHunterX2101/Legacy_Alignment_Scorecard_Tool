...
import { Search, Zap, BarChart3, Users, ArrowRight, Target, Brain, TrendingUp } from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-6">
              <div className="p-3 bg-gradient-to-br from-[#2563EB] to-[#6366F1] rounded-xl mr-4">
            ...
            <div className="max-w-4xl mx-auto mb-12">
              <div className="bg-[#2A2D31] rounded-2xl border border-gray-700 p-8 shadow-2xl">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
          {quickStats.map((stat, index) => (
            <div key={index} className="bg-[#2A2D31] rounded-lg border border-gray-700 p-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <div key={index} className="bg-[#2A2D31] rounded-xl border border-gray-700 p-8 hover:border-gray-600 transition-all duration-200 group">
        ...
        {/* Recent Activity */}
        <div className="bg-[#2A2D31] rounded-xl border border-gray-700 p-8">
